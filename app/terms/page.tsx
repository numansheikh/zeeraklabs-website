...
export const metadata: Metadata = { title: 'Terms of Service | Zeerak Labs' }
  ...
  return (
    <main className="min-h-screen bg-background flex items-center justify-center px-8">
      <div className="text-center">
        ...
        <h1 className="text-5xl font-headline font-bold text-on-surface mb-6">Terms of Service</h1>
